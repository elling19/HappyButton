...
L["If you prefer the old editing window, use /hbo to open it."] = true
L["Settings"] = true
L["Teleport"] = true
L["Class"] = true
L["Profession"] = true
...
L["Open Icon Picker"] = true
L["Open Icon Picker::Desc"] = "Choose an icon from the picker, or keep using manual input for custom texture paths."
L["Icon Picker"] = true
L["All"] = true
L["Grid Layout"] = true
L["Drawer Layout"] = true
L["Flyout"] = true
L["Auto collapse flyout after button click"] = true
