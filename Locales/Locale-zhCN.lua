...
L["If you prefer the old editing window, use /hbo to open it."] = "如果你更喜欢旧版编辑窗口，请使用 /hbo 来打开。"
L["Settings"] = "设置"
L["Teleport"] = "传送"
L["Class"] = "职业"
L["Profession"] = "专业"
...
L["Open Icon Picker"] = "打开图标选择器"
L["Open Icon Picker::Desc"] = "可从图标选择器中选择图标；若需自定义贴图路径，仍可继续手动输入。"
L["Icon Picker"] = "图标选择器"
L["All"] = "全部"
L["Grid Layout"] = "平铺式"
L["Drawer Layout"] = "抽屉式"
L["Flyout"] = "Flyout 抽屉模式"
L["Auto collapse flyout after button click"] = "点击按钮后自动收起 Flyout"
...
L["Create from item name or id, one step."] = "输入物品名或ID，一步创建物品。"
L["Create Item"] = "创建物品"
L["Create Other Element"] = "创建其他元素"
L["Create"] = "创建"
L["Item List"] = "物品列表"
L["List"] = "列表"
L["Element"] = "元素"
...
L["Bindkey Help Content"] = "当前绑定按键会通过覆盖绑定生效。\n\n若出现绑定按键导致动作条按钮无法工作，请尝试开启战斗状态加载条件，并设置为战斗外加载。\n\n不建议在 flyout 模式中使用绑定按键功能，除非你明确知道它的运行方式。"
